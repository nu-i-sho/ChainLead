namespace ChainLead.Test
{
    ...
    {
        public static class HandlerMathFixtureCases
        {
                ...
                : IHandlerMathFactory
            {
                ...
                class Product(IHandlerMath math)
                    : SingleHandlerFixtureCases.OriginalMathFactory.Product(math),
                    ITestingHandlerMath
                {
                ...
                : IHandlerMathFactory
            {
                ...
                class Product(IConditionMath conditionMath)
                    : SingleHandlerFixtureCases.SyntaxMathFactory.Product(conditionMath),
                    ITestingHandlerMath
                {
                    public IHandler<T> FirstThenSecond<T>(IHandler<T> a, IHandler<T> b) =>
